...
%\item[] Expected to graduate in Aug, 2024
%\end{itemize}
...
%\section{EDUCATION}
\section{Education}
Ph.D. in Computer Science, Yonsei University, South Korea \hfill Expected Aug 2024
\begin{itemize} \itemsep -2pt % Reduce space between items
\item[-] Dissertation topic: Competitive algorithms for online algorithms with hard requirements relaxed
\item[-] Advisor: Hyung-Chan An
\end{itemize}
...
\begin{itemize} \itemsep -2pt % Reduce space between items
%\item[-]  The preliminary paper titled ``Constant-factor approximation algorithms for the parity-constrained facility location problem'' appeared in \emph{ISAAC 2020: Proceedings of the 31st International Symposium on Algorithms and Computation}, pages 21:1-21:17, 2020.
\item[-]  The preliminary version has appeared in \emph{ISAAC 2020: Proceedings of the 31st International Symposium on Algorithms and Computation}, pages 21:1-21:17, 2020.
