...
\vspace{\killinitspace}
\begin{itemize}
\item %In this paper, we present improved learning-augmented algorithms for the multi-option ski rental problem.
...
%, and computational experiments evaluating our algorithms’ performance improvements.
\end{itemize}
